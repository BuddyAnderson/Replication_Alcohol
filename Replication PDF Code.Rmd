...
- We define heavy drinkers as those that reported drinking more than 6 drinks each day

## Table...
```{r, echo=FALSE, results='asis', message=FALSE}
source("heterogeneous effects.R")
library(stargazer)
stargazer(lm1, lm2, lm3, type = "latex", title = "Regression Results", header = F)
stargazer(lm4, lm5, lm6, type = "latex", title = "Regression Results", header = F)
```
